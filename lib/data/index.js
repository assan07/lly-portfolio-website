...
// Merges the seed data with the remote data, preferring remote values when available.
function mergeWithSeed(seed, remote) {
...
export async function getProfile() {
  ...
  const profile = mergeWithSeed(seedProfile, remote)

  return {
    ...profile,
    socials: mergeWithSeed(seedProfile.socials, remote?.socials),
  }
}
